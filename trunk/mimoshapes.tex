...
\pgfdeclareshape{mimotres}{
  ...
  % Inherit saved anchor from rectangle (\northeast and \southwest)
  % \inheritsavedanchors[from=rectangle]
  \inheritsavedanchors[from=mimodois]

  % Inherit anchor border from mimodois
  \inheritanchorborder[from=mimodois]

  % Inherit normal anchors from mimodois
  \inheritanchor[from=mimodois]{center}
  \inheritanchor[from=mimodois]{north}
  \inheritanchor[from=mimodois]{east}
  \inheritanchor[from=mimodois]{south}
  \inheritanchor[from=mimodois]{west}
  \inheritanchor[from=mimodois]{north east}
  \inheritanchor[from=mimodois]{north west}
  \inheritanchor[from=mimodois]{south west}
  \inheritanchor[from=mimodois]{south east}
  \inheritanchor[from=mimodois]{text}
  % \inheritanchor[from=mimodois]{base}
  % \inheritanchor[from=mimodois]{mid}
  ...
  % Define some more useful anchors
  \anchor{first antenna base start}{\pgf@anchor@mimotres@A}
  \anchor{second antenna base start}{\pgf@anchor@mimotres@B}
  \anchor{third antenna base start}{\pgf@anchor@mimotres@C}
  ...
  \anchor{first antenna base end}{
    ...
    \csname pgf@anchor@mimotres@first antenna base start\endcsname
    \advance\pgf@x by \antennaoffset%
    \advance\pgf@y by 0.2cm%
  }
  \anchor{second antenna base end}{
    \csname pgf@anchor@mimotres@second antenna base start\endcsname
    \advance\pgf@x by \antennaoffset%
    \advance\pgf@y by 0.2cm%
  }
  \anchor{third antenna base end}{
    \csname pgf@anchor@mimotres@third antenna base start\endcsname
    \advance\pgf@x by \antennaoffset%
    \advance\pgf@y by 0.2cm%
  }
  \anchor{first antenna}{
  ...
  \backgroundpath{
    ...
    \csname pgf@anchor@\shape@name @A\endcsname
    %\pgf@anchor@mimotres@A
    \drawantenna
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


    %%%%% Draw the second antenna %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %% \pgf@anchor@mimotres@B
    \csname pgf@anchor@\shape@name @B\endcsname
    \drawantenna
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pgfdeclareshape{caixadois}{
  ...
  \backgroundpath{
    ...
    {
      \csname pgf@anchor@\shape@name @A\endcsname
      \pgfcircle{\pgfpoint{\pgf@x}\pgf@y{}}{2mm}
      \csname pgf@anchor@\shape@name @B\endcsname
      \pgfcircle{\pgfpoint{\pgf@x}\pgf@y{}}{2mm}
      \pgfsetfillcolor{\pgfkeysvalueof{/pgf/circle color}}
      \pgfusepath{stroke,fill}
    }
  }
}
