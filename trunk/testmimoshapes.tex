...
\begin{tikzpicture}
  ...
  \tikzset{test mimo node/.style={fill=blue!30,draw,mimodois,antenna offset=0.3cm,thick}}
  ...
  \draw (mimo3) node[test mimo node,mimotres] (mynode3) {\pgftypesetversion};
  \node[test mimo node,right=3cm of mynode3,mimotres,left antennas] (mynode4) {\pgftypesetversion};
  ...
  \draw (mimocaixa) node[test mimo node,caixadois] (mimocaixa2) {\pgftypesetversion};
  \node[test mimo node,right=3cm of mimocaixa2,caixatres] (mimocaixa3) {\pgftypesetversion};
