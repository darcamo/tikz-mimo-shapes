...
\begin{tikzpicture}
  ...
  \draw (pos1) node[fill=blue!30,draw,mimodoisesquerda,antenna offset=0.5cm,minimum size=\tamanhoDoNode] (mynode) {\pgftypesetversion};

  \node[fill=blue!30,draw,mimodoisdireita,antenna offset=0.5cm,minimum size=\tamanhoDoNode,above=1cm of mynode] (mynode2) {\pgftypesetversion};
  ...
  \foreach \ancora in {
    ...
    first antenna,
    second antenna} % text is the same as the center anchor
  {
